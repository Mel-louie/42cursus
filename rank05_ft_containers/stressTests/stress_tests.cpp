...
/*   Updated: 2022/01/20 18:13:34 by mel-louie        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	start measuring time
	...
	s.insert(s.begin(), s.find(999999));
	...
	f.insert(f.begin(), f.find(999999));
	...
	if (ft_elapsed > std_elapsed * 20)
	{
		...
		std::cout << "ft::map time:  " << ft_elapsed << std::endl
			<< "std::map time: " << std_elapsed << " | (std time * 20) = "<< std_elapsed * 20 << std::endl;
		return (1);
	}
	else
	{
