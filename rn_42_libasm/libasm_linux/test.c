...
/*   Updated: 2020/08/19 11:05:13 by mdesfont         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_strcpy_test()
{
	...
	printf("\n(below in the main (in comments), test to see if it's segfault if NULL:)\n");
	printf("%s", RESET);
	//printf("NULL SRC TEST: FT_STRCPY: dst = %s|\n", ft_strcpy("hello hello", NULL));
	//printf("NULL DST TEST: FT_STRCPY: dst = %s|\n", ft_strcpy(NULL, "hello hello"));
