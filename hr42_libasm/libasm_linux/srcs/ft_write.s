section .text
	global ft_write			; the entry point
	extern __errno_location	; implement errno from the definition in /usr/include/errno.h

ft_write:					;ssize_t		ft_write(int fd, void *buf, size_t count);
	push rbp
	mov rbp, rsp
	mov rax, 1				; 1 is the syscall code of write, to obtain easily this code on linux: printf SYS_write | gcc -include sys/syscall.h -E - https://unix.stackexchange.com/questions/421750/where-do-you-find-the-syscall-table-for-linux
	syscall					; so, put the syscall's code on the rax register and invoke it
