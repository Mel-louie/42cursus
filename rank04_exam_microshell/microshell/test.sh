...
# gcc -g -Wall -Werror -Wextra -DTEST_SH main.c -o microshell
printf "\e[1;36mTest\n\e[0m"
mkdir results
...
test_my_line /bin/cat main.c
test_line $(/bin/cat main.c)
comp_results

test_my_line /bin/ls main.c
test_line $(/bin/ls main.c)
comp_results

test_my_line /bin/ls main.c ";" /bin/ls
test_line $(/bin/ls main.c ; /bin/ls)
comp_results
...
#test_line /bin/ls ftest ";" /bin/ls ";" /bin/ls werwer ";" /bin/ls main.c ";" /bin/ls subject.fr.txt ";"
